...
router.post('/', isLoggedIn, upload.single('image'), validateEvent, validateResult, eventController.create);
...
router.put('/:id', isLoggedIn, validateId, isAuthor, upload.single('image'), validateEvent, validateResult, eventController.update);
